    ...
    <footer className="bg-emerald-700 text-white py-10 px-4">
      <div className=" mx-20 px-20 py-10 bg-emerald-600 rounded-3xl shadow-2xl shadow-emerald-800">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-3xl font-serif mb-4 py-4 pr-16">
              Helping everyone declutter their mental queries
            </h3>
          </div>
          <div>
      ...
      {/* Centered note */}
      <div className="text-center pt-6">Made with ❤️ in Manipal</div>

      {/* Enlarged Sachetana text */}
      <div className="text-center text-20rem md:text-[2rem] text-emerald-800 py-2">
        Sachetana
      </div>
    </footer>
  );
